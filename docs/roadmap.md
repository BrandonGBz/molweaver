...
- Batch rendering
- Export `.pml` scripts
- Export editable `.pse` sessions
- Metadata JSON
- Residue highlighting
- Distance measurements
- Structural inspection and site analysis
- Structured scene operations for show/hide/color/remove/select/label/zoom/orient/center
- One-command installer for Windows and experimental Unix-like systems
